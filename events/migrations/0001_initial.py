    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='users.city', verbose_name='Город проведения')),
                ('favorited_by', models.ManyToManyField(blank=True, related_name='favorite_events', to=settings.AUTH_USER_MODEL, verbose_name='Добавили в избранное')),
                ('tags', models.ManyToManyField(to='users.tag', verbose_name='Теги')),
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='events.eventtype', verbose_name='Тип события')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speakers', models.ManyToManyField(blank=True, to='events.speaker', verbose_name='Спикеры')),
            ],
            options={
