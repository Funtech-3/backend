    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_status', models.CharField(choices=[('OPEN', 'Регистрация открыта'), ('CLOSED', 'Регистрация завершена'), ('PENDING', 'Ожидание регистрации')], default='PENDING', max_length=7, verbose_name='Статус регистрации')),
                ('mode', models.CharField(choices=[('ONLINE', 'Онлайн'), ('OFFLINE', 'Офлайн')], default='OFFLINE', max_length=7, verbose_name='Формат проведения')),
